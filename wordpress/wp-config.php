 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         getenv('WORDPRESS_PHRASE'));
define('SECURE_AUTH_KEY',  getenv('WORDPRESS_PHRASE'));
define('LOGGED_IN_KEY',    getenv('WORDPRESS_PHRASE'));
define('NONCE_KEY',        getenv('WORDPRESS_PHRASE'));
define('AUTH_SALT',        getenv('WORDPRESS_PHRASE'));
