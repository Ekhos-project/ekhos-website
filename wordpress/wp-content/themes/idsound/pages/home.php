...
<section class="section section-home" id="hero">
    <div class="hero_container">
        ...
        <a href="/produits/" class="button endicon">Découvrir</a>
    </div>
</section>
    ...
    <div class="stories_container">
        <div class="stories_description">
            ...
            <div class="stories_description_action">
                <a href="/produits/" class="button endicon">En savoir plus</a>
            </div>
        </div>
...
<section class="section section-home" id="build">
    <div class="build_container">
        ...
        <div class="build_contents">
            ...
            <div class="build_content build_content-reverse">
                <div class="build_content_image build_content_image-reverse">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home_build_image-2.png"
                         alt="Sons">
                </div>
                <div class="build_content_description">
        ...
        <a href="/produits/" class="button endicon">Nos accompagnements</a>
    </div>
</section>
